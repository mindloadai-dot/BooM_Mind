...
class AchievementTrackerService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      developer.log('Achievement tracker initialized with local data', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to initialize achievement tracker: $e', name: 'AchievementTracker', level: 900);
  ...
  Future<void> _loadTrackingData() async {
    try {
      ...
      if (trackingJson != null) {
        ...
        _quizzes85PercentOrHigher = trackingData['quizzes85PercentOrHigher'] ?? 0;
        _fivePerWeekCounter = trackingData['fivePerWeekCounter'] ?? 0;
        _distractionFreeSessionsCount = trackingData['distractionFreeSessionsCount'] ?? 0;
        ...
        developer.log('Loaded tracking data from local storage', name: 'AchievementTracker');
      }
    } catch (e) {
      developer.log('Failed to load tracking data: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> _saveTrackingData() async {
    try {
      ...
      developer.log('Failed to save tracking data: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackStudyTime(int minutes, {String? context}) async {
    try {
      ...
      developer.log('Study time tracked: $minutes min (total: $_totalStudyMinutes, context: $context)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track study time: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackCardsCreated(int count, {String? cardType}) async {
    try {
      ...
      developer.log('Cards created tracked: $count (total: $_totalCardsCreated, type: $cardType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track cards created: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackQuizStarted({
    ...
    try {
      ...
      developer.log('Quiz started tracked: $quizId ($questionCount questions, type: $quizType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track quiz started: $e', name: 'AchievementTracker', level: 900);
    }
  }

  /// Track quiz completion with enhanced tracking
  Future<void> trackQuizCompleted(double scorePercent, {
    int? totalQuestions,
    String? quizType,
    Duration? timeTaken,
  }) async {
    try {
      ...
      if (scorePercent >= 0.85) { // 85% or higher
      ...
      developer.log('Quiz completed: ${(scorePercent * 100).toInt()}% (mastery count: $_quizzes85PercentOrHigher, type: $quizType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track quiz completion: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackUltraSession({
    ...
    try {
      ...
      developer.log('Ultra session tracked: $_ultraSessionsCount (duration: ${durationMinutes ?? 'N/A'} min, completed: $wasCompleted)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track ultra session: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackUltraSessionCompletion(int durationMinutes) async {
    try {
      ...
      developer.log('Ultra session completed: ${durationMinutes}min', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track ultra session completion: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackContentCreation({
    ...
    try {
      ...
      developer.log('Content creation tracked: $title ($contentLength chars, type: $contentType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track content creation: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackExport({
    ...
    try {
      ...
      developer.log('Export tracked: $_totalExports (type: $exportType, count: $itemCount, format: $format)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track export: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackStudySetCreated({
    ...
    try {
      ...
      developer.log('Study set created tracked: $_totalSetsMade (cards: $cardCount, type: $setType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track study set creation: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> _updateWeeklyStudyPattern() async {
    try {
      ...
      if (_fivePerWeekCounter >= 5) {
        ...
        final updates = <String, int>{};
        updates[AchievementConstants.fivePerWeek] = 1; // Mark as achieved for this week
        
        await AchievementService.instance.bulkUpdateProgress(updates);
      }
    } catch (e) {
      developer.log('Failed to update weekly study pattern: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> _updateDistractionFreeAchievements() async {
    try {
      ...
      updates[AchievementConstants.distractionFree] = _distractionFreeSessionsCount;
      
      await AchievementService.instance.bulkUpdateProgress(updates);
    } catch (e) {
      developer.log('Failed to update distraction-free achievements: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> _updateEfficientSetAchievements() async {
    try {
      ...
      developer.log('Failed to update efficient set achievements: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> resetTrackingData() async {
    ...
    developer.log('Achievement tracking data reset', name: 'AchievementTracker');
  }
  ...
  Future<void> simulateProgress() async {
    try {
      developer.log('Simulating achievement progress for demo', name: 'AchievementTracker');
      ...
      developer.log('Achievement progress simulation complete', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to simulate achievement progress: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackDocumentUpload({
    ...
    try {
      ...
      developer.log('Document upload tracked: $fileName ($fileSize bytes, .$fileExtension)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track document upload: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackDocumentProcessed({
    ...
    try {
      ...
      developer.log('Document processed tracked: $fileName ($pageCount pages)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track document processing: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackStudySetFromDocument({
    ...
    try {
      ...
      developer.log('Study set from document tracked: $documentName ($cardCount cards, $documentType)', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track study set from document: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> trackFlashcardReview({
    ...
    try {
      ...
      developer.log('Flashcard review tracked: $cardCount cards, $correctAnswers correct, ${reviewTime.inMinutes}min', name: 'AchievementTracker');
    } catch (e) {
      developer.log('Failed to track flashcard review: $e', name: 'AchievementTracker', level: 900);
    }
  }
  ...
  Future<void> _updateReviewAchievements() async {
    try {
      ...
      developer.log('Failed to update review achievements: $e', name: 'AchievementTracker', level: 900);
    }
  }
}