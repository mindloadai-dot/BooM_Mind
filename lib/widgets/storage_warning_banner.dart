...
class StorageWarningBanner extends StatelessWidget {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          _getWarningMessage(usagePercentage, totalBytes, budgetMB),
  ...
  Color _getBannerColor(BuildContext context, double usagePercentage) {
    if (usagePercentage >= 0.95) return context.tokens.error.withValues(alpha: 0.1);
    if (usagePercentage >= 0.9) return context.tokens.error.withValues(alpha: 0.1);
    if (usagePercentage >= 0.8) return context.tokens.warning.withValues(alpha: 0.1);
    return context.tokens.warning.withValues(alpha: 0.1);
  }
  
  Color _getBorderColor(BuildContext context, double usagePercentage) {
    if (usagePercentage >= 0.95) return context.tokens.error.withValues(alpha: 0.3);
    if (usagePercentage >= 0.9) return context.tokens.error.withValues(alpha: 0.3);
    if (usagePercentage >= 0.8) return context.tokens.warning.withValues(alpha: 0.3);
    return context.tokens.warning.withValues(alpha: 0.3);
  }
  
  Color _getIconColor(BuildContext context, double usagePercentage) {
    if (usagePercentage >= 0.95) return context.tokens.error;
    if (usagePercentage >= 0.9) return context.tokens.error;
    if (usagePercentage >= 0.8) return context.tokens.warning;
  ...
  IconData _getWarningIcon(double usagePercentage) {
    if (usagePercentage >= 0.95) return Icons.error;
    if (usagePercentage >= 0.9) return Icons.error_outline;
    if (usagePercentage >= 0.8) return Icons.warning_amber_rounded;
    return Icons.info_outline;
  }
  
  String _getWarningTitle(double usagePercentage) {
    if (usagePercentage >= 0.95) return 'Critical Storage Warning';
    if (usagePercentage >= 0.9) return 'Storage Critical';
    if (usagePercentage >= 0.8) return 'Storage Almost Full';
    return 'Storage Notice';
  }
  
  String _getWarningMessage(double usagePercentage, int totalBytes, int budgetMB) {
