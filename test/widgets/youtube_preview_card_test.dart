...
void main() {
  group('YouTubePreviewCard', () {
    ...
    testWidgets('should render video title correctly',
    ...
    testWidgets('should render channel name correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should render duration correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should render token information correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should render status pill correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show correct button text when captions not available',
        (WidgetTester tester) async {
      ...
      await tester
          .pumpWidget(createTestWidget(preview: previewWithoutCaptions));

      expect(find.text('No transcript available'), findsOneWidget);
    });

    testWidgets('should show correct button text when blocked',
        (WidgetTester tester) async {
    ...
    testWidgets('should show correct button text when ready to ingest',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should call onIngest when long press is completed',
        (WidgetTester tester) async {
    ...
    testWidgets('should show error message when provided',
        (WidgetTester tester) async {
    ...
    testWidgets('should format duration correctly for different lengths',
        (WidgetTester tester) async {
      ...
      final longPreview =
          mockPreview.copyWith(durationSeconds: 7325); // 2:02:05
      await tester.pumpWidget(createTestWidget(preview: longPreview));
      expect(find.text('2:02:05'), findsOneWidget);
    });

    testWidgets('should handle different status colors correctly',
        (WidgetTester tester) async {
      // Test success status
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show thumbnail placeholder when loading',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show play button overlay on thumbnail',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('should show duration badge on thumbnail',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
